...
contract ERC20 is Context, IERC20, IERC20Metadata, Inscription404 {
    ...
    function _transfer(
        ...
        emit TransferToken(sender, recipient,amount,decimals());
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit TransferToken(address(0),account,amount,decimals());
...
contract InscriptionToken is Ownable, ERC20 {
    ...
    uint256 public maxMintCount = 21000;
    ...
    constructor() ERC20("Inscription404", "INS") {
    ...
    //     returns (bool)
    // {
    //     _transfer(_msgSender(), recipient, 1 * 10**decimals());

    //     emit  TransferToken(tokenID,msg.sender,recipient);
    //     return true;
    // }
    ...
    function mint(uint256 amount) external payable {
        ...
        require(mintedCount < maxMintCount, "Mint limit reached");
        require(amount < maxPerMint, "One time mint limit reached");

        _mint(msg.sender, amount * 10**decimals());
        mintedCount += amount;

        // You can handle the data here as needed
        // emit MintWithData(msg.sender, amount, data);
    }
